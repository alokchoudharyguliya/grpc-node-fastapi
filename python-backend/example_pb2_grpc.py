...
class ExampleServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessImage = channel.unary_unary(
                '/example.ExampleService/ProcessImage',
                request_serializer=example__pb2.ImageRequest.SerializeToString,
                response_deserializer=example__pb2.ImageResponse.FromString,
                _registered_method=True)
...
def add_ExampleServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ProcessImage': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=example__pb2.ImageRequest.FromString,
                    response_serializer=example__pb2.ImageResponse.SerializeToString,
            ),
    }
...
class ExampleService(object):
    ...
    def ProcessImage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/example.ExampleService/ProcessImage',
            example__pb2.ImageRequest.SerializeToString,
            example__pb2.ImageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
